...
public class OutlineShaderCustomEditor : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        //UnityEditor.PlayModeWindow.GetRenderingResolution(out w, out h);

        /// Store minimum depth value
        //float minDepth = material.GetFloat("_MinDepth");
        ...
        if (scaleWithDepth)
        {
            /// Setup maximum depth field 
            //minDepth = EditorGUILayout.FloatField("Minimum Depth", material.GetFloat("_MinDepth"));


            /// Setup maximum depth field 
            //maxDepth = EditorGUILayout.FloatField("Maximum Depth", material.GetFloat("_MaxDepth"));
